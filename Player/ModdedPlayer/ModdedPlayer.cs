...
namespace ChampionsOfForest.Player
{
	public partial class ModdedPlayer : MonoBehaviour
	{
		...
		public static void ResetAllStats()
		{
			...
			SpellActions.BashExtraDamage = 1.3f;
			SpellActions.BIA_TripleDmg = false;
			SpellActions.BashDamageBuff = 1f;
			SpellActions.BashSlowAmount = 0.4f;
			...
			SpellActions.MagicArrowCrit = false;
			SpellActions.BL_Crit = false;
			...
			instance.EruptionBow = false;
			instance.ArchangelBow = false;
			instance.GoldenResolve = false;
			...
			instance.ProjectileDamageIncreasedBySpeed = false;
			...
			instance.ParryAnything = false;
			instance.BlackholePullImmune = false;
			instance.TrueAim = false;
			instance.TrueAimUpgrade = false;
			instance.thornsMult = 1;
			instance.thorns = 0;
			instance.thornsPerStrenght = 0;
			instance.CraftingPolishing = false;
			instance.CraftingEmpowering = false;
			instance.isShieldAutocast = false;
			instance.thornsPerVit = 0;
			MaxLogs = 2;
		...
		public static int RangedRepetitions()
		{
			...
			if (Effects.Multishot.IsOn)
			{
				bool b = ModdedPlayer.instance.SoraSpecial ? SpellCaster.RemoveStamina(Mathf.Pow(ModdedPlayer.instance.MultishotCount, 1.75f)) : SpellCaster.RemoveStamina(10 * Mathf.Pow(ModdedPlayer.instance.MultishotCount, 1.75f));
				if (b)
				{
					repeats += ModdedPlayer.instance.MultishotCount;
					if (ModdedPlayer.instance.SoraSpecial)
						repeats += 4;
				}
				else
				{
