...
namespace ChampionsOfForest.Player
{
	public static class SpellDataBase
	{
		...
		public static void FillSpells()
		{
			...
			new Spell(25, 189, 14, 40, 45, "Taunt", "Makes enemies hyper agressive and forces them to attack you. Taunted enemies move twice attack twice as fast and take 30% increased damage")
			{
