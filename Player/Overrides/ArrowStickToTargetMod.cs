...
namespace ChampionsOfForest.Player
{
	public class XArrowStickToTargetMod : arrowStickToTarget
	{
		public override bool stickArrowToNearestBone(Transform arrow)
		{
			...
			if (ModdedPlayer.Stats.perk_projectileNoConsumeChance > 0.35f || (int)ModSettings.difficulty > 2)
			{
				float multishotMult = Mathf.Min(14.4f, ModdedPlayer.Stats.perk_projectileNoConsumeChance / 0.9f);
