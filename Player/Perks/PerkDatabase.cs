	...
	public class PerkDatabase
	{
		...
		public static void FillPerkList()
		{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_2/*og:Gene allows muscles to quickly change their structure to a more efficient one.\nEvery point of STRENGTH increases MEELE DAMAGE by 1%.*/,//tr
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_4/*og:Gene changes the composition of axon sheath that greatly increases brain's power.\nEvery point of INTELLIGENCE increases SPELL DAMAGE by 1%.*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_6/*og:Neural connections between muscles and the brain are now a lot more sensitive. Your movements become a lot more precise.\nEvery point of AGILITY increases RANGED DAMAGE by 1%.*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_8/*og:Heart's muscles become even more resistant to exhaustion.\nEvery point of intelligence increases stamina and energy recovery rate by 1%.*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_12/*og:Skin and bones become more resistant to injuries.\nEvery point of VITALITY increases max health by 1.75*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_14/*og:Blood becomes denser and binds more oxygen, is less vulnerable to bleeding and wounds are healed faster. Stamina and energy recover faster.\nIncreases all healing and recovery by 7.5%*/,//tr
				updateDescription = x =>
				{
					float f = 1.05f;
					for (int i = 1; i < x; i++)
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_17/*og:Additional microorganisms are now present in the digestive system. Sweating is decreased\nDecreases hunger and thirst rate by 10%.*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_23/*og:Grip strength increases.\nIncreases melee damage by 5*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_25/*og:Biceps slightly increases in size.\nIncreases melee damage by 10%*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_27/*og:All flexors gain in size.\nIncreases strength by 15*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_29/*og:Shoulder muscles grow.\nIncreases projectile damage by 8*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_35/*og:The costs of casting spells become easier to quickly recover from.\n10% of the spell cost is now taxed from stamina instead of energy.*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_37/*og:In order to preserve energy, spell costs are reduced by 4%*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				posX = 2f,
				posY = 0.75f,
				name = Translations.PerkDatabase_38/*og:Undestructable*/,//tr
				originalDescription = Translations.PerkDatabase_39/*og:Decreases all damage taken and decreases all damage dealt by 30%*/,//tr
				textureVariation = 0, //0 or 1
				uncapped = false,
			};
			new Perk()
			{
				...
				posX = 2.5f,
				posY = 1.5f,
				name = Translations.PerkDatabase_40/*og:Cool Down Reduction*/,//tr
				originalDescription = Translations.PerkDatabase_41/*og: Reduces spell cooldown by 5%*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_45/*og:+5 to every strength, agility, vitality and intelligence*/,//tr
				textureVariation = 0,
				uncapped = false,
			};
			...
			new Perk()
			{
				...
				posY = 0f,
				name = Translations.PerkDatabase_44/*og:All attributes*/,//tr
				originalDescription = Translations.PerkDatabase_46/*og:+15 to every strength, agility, vitality and intelligence*/,//tr
				textureVariation = 0,
				uncapped = false,
			};
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_47/*og:+4% to attack speed */,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_55/*og:Increases jump height by 6%*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_57/*og:Increases movement speed by 3.5%*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_59/*og:Increases health by 25. This is further multiplied by maximum health percent.*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_64/*og:Increases armor by 40.*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_66/*og:Decreases all damage taken by 10%.*/,//tr
				textureVariation = 0,
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_68/*og:Further decreases all damage taken by 10%.*/,//tr
				textureVariation = 0,
				uncapped = false,
			};
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_70/*og:Decreases magic damage taken by 7%*/,//tr
				textureVariation = 0,
				uncapped = true,
				updateDescription = x =>
				{
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_72/*og:Increases dodge chance by 25%*/,//tr
				textureVariation = 0,
				uncapped = false,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_74/*og:Increases armor penetration from all sources by 3*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_78/*og:Increases armor penetration from ranged weapons by 5*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
			...
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_96/*og:Increases daily generation of dynamite by 2. If it exceeds your max amount of bombs carried, excess will be lost.*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_98/*og:Increases daily generation of meds by 1. If it exceeds your max amount of bombs carried, excess will be lost.*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_100/*og:Increases daily generation of fuel cans by 1. If it exceeds your max amount of bombs carried, excess will be lost.*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
			{
				...
				originalDescription = Translations.PerkDatabase_102/*og:Increases daily generation of booze by 2. If it exceeds your max amount of bombs carried, excess will be lost.*/,//tr
				textureVariation = 0,
				uncapped = true,
			};
			new Perk()
