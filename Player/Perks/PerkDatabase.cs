...
namespace ChampionsOfForest.Player
{
	public class PerkDatabase
    {
        ...
        public static void FillPerkList()
        {
            ...
            new Perk()
            {
                apply = () => { ModdedPlayer.instance.MeleeDamageAmplifier_Add += 0.25f; ModdedPlayer.instance.StaminaAttackCost *= 1.3f; },
                ...
                posY = -0.75f,
                name = "Power Swing",
                originalDescription = "Attacks use 30% more stamina and deal 25% more damage",
                textureVariation = 0,
                uncapped = true,
                updateDescription = x =>
                {
            ...
            new Perk()
            {
                apply = () => ModdedPlayer.instance.HeavyAttackMult *= 2f,
            ...
            new Perk()
            {
                apply = () => ModdedPlayer.instance.CritDamage += 5,
                ...
                posY = 0.75f,
                name = "Lucky Hits",
                originalDescription = "Increases Critical hit damage by 5%",
                textureVariation = 0,
                uncapped = true,
            };
            new Perk()
            ...
            new Perk()
            {
                apply = () => { ModdedPlayer.instance.AttackSpeedMult *= 1.65f; ModdedPlayer.instance.MeleeDamageAmplifier_Mult*= 0.5f; ModdedPlayer.instance.RangedDamageAmplifier_Mult /= 10; },
                category = PerkCategory.MeleeOffense,
                texture = null,
                ...
                originalDescription = "Increases attack speed by 65%, but decreases melee damage by 50% and ranged damage by 90%",
                textureVariation = 1, //0 or 1
                uncapped = false,
            };
            new Perk()
            ...
            new Perk()
            {
                apply = () => { ModdedPlayer.instance.MeleeDamageAmplifier_Add+=1.1f; ModdedPlayer.instance.RangedDamageAmplifier_Mult *= 0; },
                category = PerkCategory.MeleeOffense,
                texture = null,
                unlockPath = new int[] { 89 },
                levelReq = 77,
                ...
                originalDescription = "Makes you unable to damage enemies with ranged weapons, causing all of them to deal 110% less damage, but at the same time, you deal 100% increased melee damage",
                textureVariation = 1, //0 or 1
                uncapped = false,
            };
            new Perk()
            ...
            new Perk()
            {
                apply = () => { ModdedPlayer.instance.RangedDamageAmplifier_Add +=1f; ModdedPlayer.instance.MeleeDamageAmplifier_Mult *= 0; },
                category = PerkCategory.RangedOffense,
                texture = null,
                unlockPath = new int[] { 89 },
                levelReq = 77,
                ...
                posY = -1.5f,
                name = "Curse of Binding",
                originalDescription = "Makes you unable to damage enemies with melee weapons, causing all of them to deal 100% less damage, but at the same time, you deal 100% increased ranged damage",
                textureVariation = 1, //0 or 1
                uncapped = false,
            };
            new Perk()
            ...
            new Perk()
            {
                ...
                posY = -1.5f,
                name = "Lucky Bashes",
                originalDescription = "When you bash an enemy, gain 100% critical hit damage for 2 seconds.",
                textureVariation = 0,
                uncapped = true,
            };
            new Perk()
